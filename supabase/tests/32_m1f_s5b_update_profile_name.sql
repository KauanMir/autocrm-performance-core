...
insert into public.company_memberships (id, company_id, profile_id, role, is_active, lifecycle_status, created_at) values
  ('f5b30000-0000-0000-0000-000000000001', 'f5b10000-0000-0000-0000-000000000001', 'f5b20000-0000-0000-0000-000000000001', 'manager', true,  'active',    now()),
  ('f5b30000-0000-0000-0000-000000000002', 'f5b10000-0000-0000-0000-000000000001', 'f5b20000-0000-0000-0000-000000000002', 'seller',  true,  'active',    now()),
  ('f5b30000-0000-0000-0000-000000000003', 'f5b10000-0000-0000-0000-000000000001', 'f5b20000-0000-0000-0000-000000000003', 'seller',  true,  'active',    now()), -- profile inativo
  ('f5b30000-0000-0000-0000-000000000004', 'f5b10000-0000-0000-0000-000000000001', 'f5b20000-0000-0000-0000-000000000004', 'seller',  false, 'suspended', now()), -- membership inativa
  ('f5b30000-0000-0000-0000-000000000005', 'f5b10000-0000-0000-0000-000000000002', 'f5b20000-0000-0000-0000-000000000005', 'manager', true,  'active',    now()),
  ('f5b30000-0000-0000-0000-000000000006', 'f5b10000-0000-0000-0000-000000000002', 'f5b20000-0000-0000-0000-000000000006', 'seller',  true,  'active',    now()),
  ('f5b30000-0000-0000-0000-000000000007', 'f5b10000-0000-0000-0000-000000000003', 'f5b20000-0000-0000-0000-000000000007', 'seller',  true,  'active',    now()), -- empresa cancelada
  ('f5b30000-0000-0000-0000-000000000009', 'f5b10000-0000-0000-0000-000000000002', 'f5b20000-0000-0000-0000-000000000009', 'manager', true,  'active',    now()), -- Super Admin com membership real
  ('f5b30000-0000-0000-0000-000000000012', 'f5b10000-0000-0000-0000-000000000002', 'f5b20000-0000-0000-0000-000000000012', 'seller',  true,  'active',    now()), -- legacy trap: membership REAL na empresa Y
  ('f5b30000-0000-0000-0000-000000000014', 'f5b10000-0000-0000-0000-000000000001', 'f5b20000-0000-0000-0000-000000000014', 'seller',  true,  'active',    now()); -- alvo dedicado, exclusivo da secao de auditoria

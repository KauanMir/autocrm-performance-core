...
insert into public.company_memberships (id, company_id, profile_id, role, is_active, lifecycle_status, created_at) values
  ('f5a30000-0000-0000-0000-000000000001', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000001', 'manager', true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000002', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000002', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000003', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000003', 'manager', true,  'active',    now()),  -- profile inativo: nao deve aparecer
  ('f5a30000-0000-0000-0000-000000000004', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000004', 'seller',  false, 'suspended', now()), -- membership inativa: nao deve aparecer
  ('f5a30000-0000-0000-0000-000000000005', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000005', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000006', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000006', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000007', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000007', 'manager', true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000008', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000008', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000009', 'f5a20000-0000-0000-0000-000000000001', 'f5a10000-0000-0000-0000-000000000009', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000010', 'f5a20000-0000-0000-0000-000000000002', 'f5a10000-0000-0000-0000-000000000010', 'manager', true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000011', 'f5a20000-0000-0000-0000-000000000002', 'f5a10000-0000-0000-0000-000000000011', 'seller',  true,  'active',    now()),
  ('f5a30000-0000-0000-0000-000000000020', 'f5a20000-0000-0000-0000-000000000003', 'f5a10000-0000-0000-0000-000000000020', 'seller',  true,  'active',    now()), -- empresa cancelada: nao deve aparecer
  ('f5a30000-0000-0000-0000-000000000041', 'f5a20000-0000-0000-0000-000000000005', 'f5a10000-0000-0000-0000-000000000041', 'seller',  true,  'active',    now()); -- Super Admin com membership real

...
export function useTweaks<T extends Record<string, any>>(defaults: T): [T, (keyOrEdits: any, val?: any) => void] {
...
export function TweakRow({ label, value, children, inline = false }: {
  label: string; value?: any; children?: React.ReactNode; inline?: boolean;
}) {
  return (
...
export function TweakSelect({ label, value, options, onChange }: {
  label: string; value: any; options: any[]; onChange: (v: string) => void;
}) {
  return (

...
// KPI-REPORTS-B2-EXEC-FRONTEND — ScreenResultados agora é a tela gerencial
// "Resultados V1" (get_company_management_report), implementada em
// ManagementResults.tsx. O corpo antigo (ranking de Sales + percentuais
// fixos 67/49/58/34 e motivos 40/25/20/10) foi REMOVIDO daqui (§9).
// Mesma entrada de navegação 'resultados' (§8) — App.tsx continua
// importando ScreenResultados deste módulo.
export { ScreenResultados, ManagementResultsScreen } from '@/components/screens/ManagementResults';
